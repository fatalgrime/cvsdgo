  ...
  return (
    <section>
      ...
      <div className="mt-6 rounded-md border border-slate-200 bg-white p-6">
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-3">
          <div className="rounded-md border border-slate-200 bg-slate-50 p-4">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-deepforest-700">Getting started</p>
            <p className="mt-2 text-sm text-slate-600">
              Search the Link Directory to find the official destination for common district services.
            </p>
          </div>
          <div className="rounded-md border border-slate-200 bg-slate-50 p-4">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-deepforest-700">Share links</p>
            <p className="mt-2 text-sm text-slate-600">
              Copy the short link from any card to send a shortened URL to people.
            </p>
          </div>
          <div className="rounded-md border border-slate-200 bg-slate-50 p-4">
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-deepforest-700">Report issues</p>
            <p className="mt-2 text-sm text-slate-600">
      ...
      {hasLinkManagerAccess && (
        <div className="mt-6 rounded-md border border-oxford-200 bg-white p-6">
          ...
          <div className="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-3">
            <div className="rounded-md border border-oxford-200 bg-oxford-50 p-4">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-oxford-700">Create & update</p>
              <p className="mt-2 text-sm text-slate-600">
                Confirm the destination URL, add a descriptive title, and save changes to publish updates.
              </p>
            </div>
            <div className="rounded-md border border-oxford-200 bg-oxford-50 p-4">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-oxford-700">Scheduling</p>
              <p className="mt-2 text-sm text-slate-600">
                Use release and expiration times to align links with events or anything.
              </p>
            </div>
            <div className="rounded-md border border-oxford-200 bg-oxford-50 p-4">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-oxford-700">Passwords</p>
              <p className="mt-2 text-sm text-slate-600">
